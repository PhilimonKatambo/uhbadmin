...
const ViewNormalOffer = (props) => {

    const [form, setForm] = useState(props.form);

    // useEffect(() => {
    //     setForm(props.form || form);
    // }, [props.form]);
        ...
        <div id='newOverlay2' style={{ display: props.checkOverlay ? "flex" : "none" }}>
            ...
            <div className="offer-letter" id='offer-letter' ref={dialogRef}>
                ...
                <div id='formStafff'>
                    ...
                    <p>Dear <input name="name" value={props.applicant?.firstName + " " + props.applicant?.surname || "Christian Kamtema"} onChange={handleChange} className="editable" /></p>
...
export { ViewNormalOffer, ViewMastersOffer };
